...
(function (factory) {
    ...
    class OAuthApiClient {
        ...
        createOAuthHeader(credential) {
            ...
            header_util_1.fillCredential(header, credential);
        ...
        static async create(config = {}) {
            return new OAuthApiClient(await web_client_1.createWebClient('https', 'katalk.kakao.com'), Object.assign({ ...config_1.DefaultConfiguration }, config));
        }
    }
