...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function adler32(data) {
        if (wasmCache$k === null) {
            return lockedCreate(mutex$k, wasmJson$k, 4)
                .then((wasm) => {
                wasmCache$k = wasm;
                return wasmCache$k.calculate(data);
            });
        }
        try {
            const hash = wasmCache$k.calculate(data);
    ...
    function blake2b(data, bits = 512, key = null) {
        ...
        if (wasmCache$j === null || wasmCache$j.hashLength !== hashLength) {
            return lockedCreate(mutex$j, wasmJson$j, hashLength)
                .then((wasm) => {
                wasmCache$j = wasm;
                if (initParam > 512) {
    ...
    function blake2s(data, bits = 256, key = null) {
        ...
        if (wasmCache$i === null || wasmCache$i.hashLength !== hashLength) {
            return lockedCreate(mutex$i, wasmJson$h, hashLength)
                .then((wasm) => {
                wasmCache$i = wasm;
                if (initParam > 512) {
                    wasmCache$i.writeMemory(keyBuffer);
                }
                return wasmCache$i.calculate(data, initParam);
            });
        }
        try {
            if (initParam > 512) {
            ...
            const hash = wasmCache$i.calculate(data, initParam);
            return Promise.resolve(hash);
        }
        catch (err) {
            return Promise.reject(err);
    ...
    function blake3(data, bits = 256, key = null) {
        ...
        if (wasmCache$h === null || wasmCache$h.hashLength !== hashLength) {
            return lockedCreate(mutex$h, wasmJson$g, hashLength)
                .then((wasm) => {
                wasmCache$h = wasm;
                if (initParam === 32) {
                    wasmCache$h.writeMemory(keyBuffer);
                }
                return wasmCache$h.calculate(data, initParam, digestParam);
            });
        }
        try {
            if (initParam === 32) {
            ...
            const hash = wasmCache$h.calculate(data, initParam, digestParam);
            return Promise.resolve(hash);
        }
        catch (err) {
            return Promise.reject(err);
